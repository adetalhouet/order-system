 ...
 * io.adetalhouet.order.system.client.ClientService.
 */
object ClientServiceGrpcKt {
  /**
   * A stub for issuing RPCs to a(n) io.adetalhouet.order.system.client.ClientService service as
  ...
  /**
   * Skeletal implementation of the io.adetalhouet.order.system.client.ClientService service based
  ...
  abstract class ClientServiceCoroutineImplBase(
    ...
    open suspend fun getClients(request: Empty): Clients = throw
        StatusException(UNIMPLEMENTED.withDescription("Method io.adetalhouet.order.system.client.ClientService.GetClients is unimplemented"))
    ...
    open suspend fun getClientById(request: GetClientByIdRequest): Client = throw
        StatusException(UNIMPLEMENTED.withDescription("Method io.adetalhouet.order.system.client.ClientService.GetClientById is unimplemented"))
