 ...
 * io.adetalhouet.order.system.order.grpc.OrderService.
 */
object OrderServiceGrpcKt {
  /**
   * A stub for issuing RPCs to a(n) io.adetalhouet.order.system.order.grpc.OrderService service as
  ...
  /**
   * Skeletal implementation of the io.adetalhouet.order.system.order.grpc.OrderService service
  ...
  abstract class OrderServiceCoroutineImplBase(
     ...
     * io.adetalhouet.order.system.order.grpc.OrderService.PlaceOrder.
     *
    ...
    /**
     * Returns the response to an RPC for
     * io.adetalhouet.order.system.order.grpc.OrderService.TrackOrderById.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [Status].  If this method fails with a [java.util.concurrent.CancellationException], the RPC
     * will fail
    ...
    /**
     * Returns the response to an RPC for
     * io.adetalhouet.order.system.order.grpc.OrderService.GetOrdersByClient.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [Status].  If this method fails with a [java.util.concurrent.CancellationException], the RPC
     * will fail
    ...
    open suspend fun getOrdersByClient(request: GetOrdersByClientRequest): Orders = throw
        StatusException(UNIMPLEMENTED.withDescription("Method io.adetalhouet.order.system.order.grpc.OrderService.GetOrdersByClient is unimplemented"))
